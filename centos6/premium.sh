...
# get file
wget -O /etc/premium.zip "https://raw.githubusercontent.com/reyluar03/pandavpnpro/master/centos6/premium.zip"
cd /etc/
unzip premium.zip
cd
...
#cd /root/rey
#wget -O /root/rey/l2tp-connection.php "https://raw.githubusercontent.com/reyluar03/error/master/l2tp-prem.php"
