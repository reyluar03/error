...
# get file
wget -O /etc/vip.zip "https://raw.githubusercontent.com/reyluar03/pandavpnpro/master/centos6/vip.zip"
cd /etc/
unzip vip.zip
cd
...
#get active.txt 
wget https://raw.githubusercontent.com/reyluar03/pandavpnpro/master/ssh/vipactive.sh
