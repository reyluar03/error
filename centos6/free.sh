...
#get active.txt
cd
wget https://raw.githubusercontent.com/reyluar03/pandavpnpro/master/ssh/freeactive.sh
wget https://raw.githubusercontent.com/reyluar03/pandavpnpro/master/ssh/freenotactive.sh
