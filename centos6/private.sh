...
# get file
wget -O /etc/private.zip "https://raw.githubusercontent.com/reyluar03/pandavpnpro/master/centos6/private.zip"
cd /etc/
unzip private.zip
cd
...
#get active.txt
cd
wget https://raw.githubusercontent.com/reyluar03/pandavpnpro/master/ssh/privateactive.sh
