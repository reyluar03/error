...
WHERE ".$private_active." OR ".$vip_active." ORDER by user_id DESC");
if($query->num_rows > 0)
{
...
$private_deactived = "AND private_duration <= 0";
$is_validated = "is_validated=0";
$is_activate = "is_active=0";
$freeze = "frozen=1";

$query2 = $mysqli->query("SELECT * FROM users WHERE ".$is_validated." OR ".$freeze." OR  ".$vip_deactived." OR ".$private_deactived."
");
